...
import dflowautotest.calculator.lib.lammps as lammps
#from dpgen import dlog
from dflowautotest.calculator.lib.lammps import (
    inter_deepmd,
    inter_eam_alloy,
    inter_eam_fs,
    inter_meam,
)
from dflowautotest.calculator.Task import Task
    ...
    def make_input_file(self, output_dir, task_type, task_param):
        ...
        if os.path.isfile(self.in_lammps) and task_type == "relaxation":
            with open(self.in_lammps, "r") as fin:
                fc = fin.read()
        # user input in.lammps for dflowautotest calculation
